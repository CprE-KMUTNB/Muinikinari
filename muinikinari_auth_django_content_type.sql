...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(7,'random_menu','menu'),(8,'random_menu','restaurant'),(10,'review','reccommend'),(9,'review','review'),(5,'sessions','session'),(6,'users','user');
